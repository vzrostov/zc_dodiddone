...
class _TasksPageState extends State<TasksPage> {
              ...
              return Dismissible(
                ...
                onDismissed: (direction) {
                  if (direction == DismissDirection.endToStart) {
                    ...
                    // Обработка свайпа вправо (например, пометка задачи как выполненной)
  ...
  Future<void> _markTaskAsCompleted(String taskId) async {
    try {
      // Добавьте логику для обновления поля "completed" в Firestore
      // Например:
      await _tasksCollection.doc(taskId).update({'completed': true});
    } catch (e) {
      print('Ошибка пометки задачи как выполненной: $e');
    }
  }
}
